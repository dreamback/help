...
(23, 17, 1, 'FSCapture抓屏工具', '<div class="para"><strong>屏幕</strong><strong>取色器</strong></div><div class="para">现在网上各式各样的取色器应该不少了，包括之前一直用的蓝色经典推荐的 ColorSPY， Firefox 下还有一个，专门的取色器扩展 ColorZilla，这些都是很好的软件。但自从使用了 FS Capture 之后，这些我都很少用到了。原因很简单，各种取色软件的功能，都大同小异，FS Capture 非常小巧，既然有这样一个小软件，能够包含取色器、屏幕放大镜和截屏的功能，为什么还要为这些功能，而分开多个软件呢？FastStone Capture 的取色支持 RGB、Dec 和 Hex 三种格式的色值，而且还有一个混色器，取到颜色之后，可以再编辑。</div><p><br /></p><div class="para"><strong>屏幕标尺</strong></div><p>FastStone Capture 还有屏幕标尺功能， 点击后会屏幕上会出现一个尺子，方便测试屏幕某区域的像素大</p><p><br /></p><div class="para"><strong>屏幕放大镜</strong></div><div class="para"><p>这确实是一个不错的功能，特别是现在，我们已经习惯用 DIV 来对页面定位，DIV之间的对齐不像表格那样容易控制，有时为了调整几个像素的偏差，不得不对着屏幕盯很久。有这样一个放大镜，就方便多了。使用时，只需点击一下，FS Capture 窗口上的放大镜图标，鼠标变成一个放大镜的样子，然后在需要放大的地方，按下右键就可以了，就像手里真的拿着一个放大镜一样。可以设置放大倍率，放大镜的尺寸，外观（圆形，矩形以及圆角矩形）以及是否平滑显示，按 ESC 键或单击右键可退出放大镜。</p><p><br /></p><p><strong>可自定义全局快捷键</strong><br /></p></div><p>推荐快捷键设置为：</p><p>取色：Alt+A</p><p>标尺：Alt+Z<br /></p><p><br /></p><p><strong><span style="color:#00b050;">绿色版：</span></strong></p><p style="line-height:16px;"><img src="/source/ueditor/dialogs/attachment/fileTypeImages/icon_rar.gif" /><a href="/source/ueditor/php/../../../UpLoadFiles/files/20130523/13692930813096.rar">FSCapture抓屏工具.rar</a></p>', '20130523654578355.jpg', '2013-05-23 06:55:08', 1),
(25, 19, 1, '兼容IE6+，伪3D图片透视动画', '<style _ue_org_tagname="style">\n	#thereD-list{list-style:none;}\n  #thereD-list li{border:3px solid #eee;float:left;margin-right:10px;overflow:hidden;position:relative;overflow:hidden;height:300px;width:200px;margin-bottom:20px;}\n\n	#thereD-list li div{\n		position:absolute;overflow:hidden;width:0;height:0;display:block;\n		overflow:hidden;\n	}\n	#thereD-list li .i1{\n		left:0;top:0;\n		border-color:#fff  #fff transparent transparent ;\n		border-style:solid dashed dashed solid;\n	}\n	#thereD-list li .i2{\n		bottom:0;left:0;\n		border-style:dashed dashed solid solid;\n		border-color:transparent #fff #fff transparent;\n	}\n	</style><h4>Demo 与 解剖\n</h4><ul id="thereD-list" class=" list-paddingleft-2"><li><p><img src="/source/ueditor/php/../../../UpLoadFiles/images//20130523/13692939175927.jpg" style="width:150px;height:300px;" /></p><div class="i1" style="border-width:50px  0px  0px 200px;"></div><div class="i2" style="border-width:0 0 50px 200px "></div><p><br /></p></li><li><p><img src="/source/ueditor/php/../../../UpLoadFiles/images//20130523/13692939174256.jpg" style="width:150px;height:300px;" /></p><div class="i1" style="border-width:50px  0px  0px 200px;"></div><div class="i2" style="border-width:0 0 50px 200px "></div><p><br /></p></li><li><p><img src="/source/ueditor/php/../../../UpLoadFiles/images//20130523/13692939172259.jpg" style="width:150px;height:300px;" /></p><div class="i1" style="border-width:50px  0px  0px 200px;"></div><div class="i2" style="border-width:0 0 50px 200px "></div><p><br /></p></li><li><p><img src="/source/ueditor/php/../../../UpLoadFiles/images//20130523/13692939175927.jpg" style="width:150px;height:300px;" /></p></li><li><div class="i1" style="border-width:50px  0px  0px 200px;border-color:#000  #000 transparent transparent ;"></div><div class="i2" style="border-width:0 0 50px 200px;border-color:transparent #000 #000 transparent;"></div></li><li><p><img src="/source/ueditor/php/../../../UpLoadFiles/images//20130523/13692939175927.jpg" style="width:150px;height:300px;" /></p><div class="i1" style="border-width:50px  0px  0px 200px;border-color:#000  #000 transparent transparent ;"></div><div class="i2" style="border-width:0 0 50px 200px;border-color:transparent #000 #000 transparent;"></div></li>\n  <li style="background:#000"><p><img src="/source/ueditor/php/../../../UpLoadFiles/images//20130523/13692939175927.jpg" style="width:150px;height:300px;" /></p><div class="i1" style="border-width:50px  0px  0px 200px;border-color:#000  #000 transparent transparent ;"></div><div class="i2" style="border-width:0 0 50px 200px;border-color:transparent #000 #000 transparent;"></div></li></ul><script _ue_org_tagname="script">\n	var speed = 600;\n	$(''#thereD-list li'').each(function(){\n		$(this).hover(function(){\n			$(this).find(''img'').stop().animate({width:200},speed);\n			$(this).find(''.i1'').stop().animate({borderWidth:''0 0 0 200px''},speed);\n			$(this).find(''.i2'').stop().animate({borderWidth:''0 0 0 200px''},speed);\n		},function(){\n			$(this).find(''img'').stop().animate({width:150},speed);\n			$(this).find(''.i1'').stop().animate({borderWidth:''50px 0 0 200px''},speed);\n			$(this).find(''.i2'').stop().animate({borderWidth:''0 0 50px 200px''},speed);\n		});\n	});\n	</script><hr /><h4>IE6+浏览效果\n</h4><p style="line-height:16px;"><img src="/source/ueditor/dialogs/attachment/fileTypeImages/icon_default.png" /><a href="/source/ueditor/php/../../../UpLoadFiles/files/20130523/13692956278853.html">图片形变动画.html</a></p><p><br /></p>', '', '2013-05-23 07:28:15', 1),
(26, 17, 1, 'Sprite Cow', '<p><span id="result_box" class="short_text" lang="zh-CN">Sprite Cow有助于你快速得到<span id="result_box" class="short_text" lang="zh-CN">Sprite</span>的背景位置和尺寸。</span></p><p><a title="Sprite Cow" target="_blank" href="http://helper.zhenai.com/tool/sprite-cow/"><span style="color:#00B050;" id="result_box" class="short_text" lang="zh-CN">点击进入</span></a><span id="result_box" class="short_text" lang="zh-CN"><br /></span></p>', '20130524932546530.png', '2013-05-24 01:38:25', 1);
